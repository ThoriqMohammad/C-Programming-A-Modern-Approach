...
int main(void)
{
    float loan, rate, payment, first_payment_remaining_balance, second_payment_remaining_balance, third_payment_remaining_balance;
    ...
    first_payment_remaining_balance = loan * (1 + rate / 1200.0) - payment;
    second_payment_remaining_balance  = first_payment_remaining_balance * (1 + rate / 1200.0) - payment;
    third_payment_remaining_balance  = second_payment_remaining_balance * (1 + rate / 1200.0) - payment;

    printf("Balance after first payment: $%.2f\n", first_payment_remaining_balance);
    printf("Balance after second payment: $%.2f\n", second_payment_remaining_balance);
    printf("Balance after third payment: $%.2f\n", third_payment_remaining_balance);
